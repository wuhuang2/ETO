...
void model1(){
	printf("接收到来自于主的任务\n");//内容//
							 ...
							 ShellAboutA(NULL,"ETO内部程序V6.1.1","Copyright (c)  2024 RCX.All Rights Reserved.\n(c)2023-2024 RCX保留所有权利", NULL);//所有权声明//		
						     exit (0);
}
void model2(){
	printf("主から課題を受ける\n");
					        ...
					        MessageBox(NULL,"主から課題を受ける","Stellarパワーは、インターフェースの情報読み取りウィンドウを送信します",MB_YESNO|MB_ICONQUESTION);
							 ...
							 printf("Copyright (c)  2024 RCX.All Rights Reserved.\n");
							 ShellAboutA(NULL,"ETO内部程序V6.1.1","Copyright (c)  2024 RCX.All Rights Reserved.", NULL);	
							 exit (0);
}
...
void model5() {
    ...
    ShellAboutA(NULL,"ETO-Internes Programm V6.1.1","Copyright (c) 2024 RCX. Alle Rechte vorbehalten.", NULL);
    exit (0);
}
...
// Main function
int main() {
    system("title 地球三体组织（ETO）内部程序  版本：V6.1.1");
    system("color F0");
